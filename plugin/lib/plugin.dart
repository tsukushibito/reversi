...
import 'plugin_bindings_generated.dart';
...
const String _libName = 'plugin';

/// The dynamic library in which the symbols for [PluginBindings] can be found.
...
final PluginBindings _bindings = PluginBindings(_dylib);
