...
impl GameEventHandler for ReversiGameEventHandler {
    fn handle(&self, event: GameEvent, param: &GameEventParameter) {
        ...
        let p = ReversiGameEventParam::new(param);
...
impl ReversiPlayerColor {
    fn new(c: &PlayerColor) -> Self {
        match c {
...
impl ReversiGameEventParam {
    fn new(param: &GameEventParameter) -> Self {
